...
--
-- Causa: a função roda com search_path = '' e o pgcrypto vive no schema
-- extensions, então digest() não é encontrada. Trocamos pelo sha256() nativo
-- do Postgres, que produz exatamente o mesmo hash hexadecimal usado hoje no
-- controle de tentativas (public_booking_attempts), sem depender de extensão.
--
-- Incremental e não destrutivo: apenas redefine a função.
-- Ordem: ... -> 20260833 -> 20260834 -> ESTE ARQUIVO.
